...
import type { EconomyConfig, BudgetAllocation, TaxPolicy } from '@policylab/shared';
...
// ── Phase 11 D-13: Read-only tax policy readout ──────────────────────────────
          ...
          >
            ...
            {isOpen && isVisible && (
              <div style={{ padding: '1rem', display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                ...
                {/* Phase 11 D-13: Read-only tax policy readout at top of Fiscal section */}
                {section === 'fiscal' && (
                  <TaxPolicyReadout policy={economyConfig.taxPolicy} />
                )}
