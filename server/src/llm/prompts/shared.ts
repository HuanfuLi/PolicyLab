...
/**
 * Ballot items are the discriminated union defined in @policylab/shared.
 * Phase 11 D-18: 'policy' (scalar) and 'law_amendment' (paragraph diff) kinds.
 * Re-exported here so existing prompt modules keep a stable import path.
 */
export type { GovernanceBallotItem } from '@policylab/shared';
